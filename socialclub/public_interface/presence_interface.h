...
#define IID_IPresenceMessageLatestVersion IID_IPresenceMessageV2
	...
	public:
		...
		virtual bool RGSC_CALL SetIntAttribute(const int localGamerIndex, const char* name, const s64 value) = 0;
		virtual bool RGSC_CALL SetDoubleAttribute(const int localGamerIndex, const char* name, const double value) = 0;
		virtual bool RGSC_CALL SetStringAttribute(const int localGamerIndex, const char* name,
		                                          const char* value) = 0; //! @}
		...
		virtual bool RGSC_CALL GetStringAttribute(const int localGamerIndex, const char* name, char* value,
		...
		virtual bool RGSC_CALL GetAttributesForGamer(const RockstarId rockstarId, IPresenceAttribute* attrs, const unsigned numAttrs, IAsyncStatus* status) = 0;
		...
		virtual bool RGSC_CALL PostMessage(const int localGamerindex, const RockstarId* recipients, const unsigned numRecipients, IPresenceMessage* message, const unsigned ttlSeconds, IAsyncStatus* status) = 0;
		...
		virtual bool RGSC_CALL Query(const char* queryName, const char* paramNameValueCsv, const int offset, const int count, char* recordsBuf, const unsigned sizeofRecordsBuf, char** records, unsigned* numRecordsRetrieved, unsigned* numRecords, IAsyncStatus* status) = 0;
		...
		virtual bool RGSC_CALL QueryCount(const char* queryName, const char* paramNameValueCsv, unsigned* count, IAsyncStatus* status) = 0;
		...
		//!
		//! \note This is an asynchronous operation.  Don't deallocate \p attrs or \p status while the operation is pending.
		virtual bool RGSC_CALL SetRichPresence(const int presenceId, IPresenceAttribute* attrs, const unsigned numAttrs, IAsyncStatus* status) = 0;
	...
	public:
		...
		virtual bool RGSC_CALL Unsubscribe(const int localGamerIndex, const char** channels,
