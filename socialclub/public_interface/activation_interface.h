...
namespace rgsc {
	...
	*/
		typedef void (*ActivationCodeCallback)(const int contentId, const char* activationCode, const ActivationAction action);
	...
	*/
		virtual RGSC_HRESULT RGSC_CALL ShowActivationCodeUi(const int contentId, const char* currentSerialNumber, const bool isAlreadyActivated, ActivationCodeCallback callback) = 0;
	...
	*/
		virtual RGSC_HRESULT RGSC_CALL ActivationCodeResult(const int contentId, const int result, StringId message) = 0;
	...
	*/
		typedef void (*LicenseRecoveryCallback)(const int contentId, const char* recoveryRequestCode, const char* recoveryResponseCode, const ActivationAction action);
