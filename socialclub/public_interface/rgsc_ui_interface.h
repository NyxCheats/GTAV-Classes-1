...
#define IID_IRgscUiWindowConfigurationLatestVersion \
	...
	public:
		RgscUiWindowConfiguration() :
		    m_X(0), m_Y(0), m_Width(0), m_Height(0), m_MinWidth(0), m_MinHeight(0), m_MaxWidth(0), m_MaxHeight(0), m_Parent(0), m_RootParent(0), m_CaptionHeight(0), m_BorderWidth(0), m_ResizeEdgeFlags(0), m_SizeGripSize(0), m_ShouldMinimizeOnClose(false) {
			m_WindowTitle [ 0 ] = L'\0';
		}
