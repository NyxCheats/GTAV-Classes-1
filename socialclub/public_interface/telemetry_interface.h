...
#define IID_ITelemetryPolicyLatestVersion IID_ITelemetryPolicyV1
	...
	public:
		...
		// ===============================================================================================
		void RGSC_CALL SetSubmissionIntervalSeconds(unsigned intervalSeconds) {
			m_SubmissionIntervalSeconds = intervalSeconds;
		}
		unsigned RGSC_CALL GetSubmissionIntervalSeconds() {
			return m_SubmissionIntervalSeconds;
		}
		void RGSC_CALL SetSubmissionTimeoutSeconds(unsigned timeoutSeconds) {
			m_SubmissionTimeoutSeconds = timeoutSeconds;
		}
		unsigned RGSC_CALL GetSubmissionTimeoutSeconds() {
			return m_SubmissionTimeoutSeconds;
		}
		void RGSC_CALL SetLogLevel(RgscTelemetryLogLevel logLevel) {
			m_ChannelLogLevel = logLevel;
		}
		RgscTelemetryLogLevel RGSC_CALL GetLogLevel() {
			return m_ChannelLogLevel;
		}
