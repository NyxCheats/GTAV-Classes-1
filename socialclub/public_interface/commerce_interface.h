...
namespace rgsc {
	...
	*/
		typedef void (*RedemptionCodeCallback)(const char* redemptionCode, const RedemptionAction action);
	...
	*/
		...
		virtual bool RGSC_CALL EntitlementV1_RegisterPurchaseBySN(int entitlementProjectId, char* serialNumber, bool* isActivated, char* skuName, unsigned skuNameBufLen, char* friendlyName, unsigned friendlyLength, IAsyncStatus* status) = 0;
